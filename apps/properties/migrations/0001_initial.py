    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='Kyiv', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='01001', max_length=100, verbose_name='Postal Code')),
                ...
                ('property_type', models.CharField(choices=[('House', 'House'), ('Apartment', 'Apartment'), ('Office', 'Office'), ('Warehouse', 'For Sale'), ('Other', 'For Sale')], default='Other', max_length=50, verbose_name='Property Type')),
