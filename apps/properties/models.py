...
class Property(TimeStampedUUIDModel):
    ...
    class PropertyType(models.TextChoices):
        ...
        WAREHOUSE = "Warehouse", _("For Sale")
        OTHER = "Other", _("For Sale")
    ...
    country = CountryField(verbose_name=_("Country"), default="UA", blank_label="(select country)")
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Kyiv")
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=100, default="01001")
